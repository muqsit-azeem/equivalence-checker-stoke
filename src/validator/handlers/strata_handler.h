...
#include "src/validator/handlers/strata_combo_handler.h"
...
public:
  ...
  StrataHandler(const bool simplify = true) : simplify_(simplify) {
    init();
  }
...
private:
  ...
  static std::string strata_path_;
