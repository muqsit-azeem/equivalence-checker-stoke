...
#ifndef STOKE_SRC_TRANSFORM_OPERAND_H
#define STOKE_SRC_TRANSFORM_OPERAND_H
...
class OperandTransform : public Transform {
...
public:
  ...
  OperandTransform(TransformPools& pools) : Transform(pools) { }
