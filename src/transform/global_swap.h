...
#ifndef STOKE_SRC_TRANSFORM_GLOBAL_SWAP_H
#define STOKE_SRC_TRANSFORM_GLOBAL_SWAP_H
...
class GlobalSwapTransform : public Transform {
...
public:
  ...
  GlobalSwapTransform(TransformPools& pools) : Transform(pools) { }
