...
#ifndef STOKE_SRC_TRANSFORM_OPCODE_WIDTH_H
#define STOKE_SRC_TRANSFORM_OPCODE_WIDTH_H
...
class OpcodeWidthTransform : public Transform {
...
public:
  ...
  OpcodeWidthTransform(TransformPools& pools) : Transform(pools) { }
